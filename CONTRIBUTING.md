...
modify the contents of the `src/clarative/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/harbinger-labs/clarative-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/harbinger-labs/clarative-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
